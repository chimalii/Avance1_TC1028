...
Mientras decida continuar ejecuta las instrucciones de la función 
conversiones() que contiene menuPrincipal() y devuelve la respuesta de 
continuar, si decide continuar (s) vuelve a ejecutar conversiones y si 
no (n), imprime un mensaje de despedida.
'''
